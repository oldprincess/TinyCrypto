...
static void test_base64_avx2()
{
    ...
    char    b64[60];
    // test encode
    base64_avx2_encode(b64, data1, sizeof(data1));
    if (strcmp(b64, b64_1) != 0)
    {
        fprintf(stderr, "err in base64_avx2_encode, file: %s, line: %d\n",
                __FILE__, __LINE__);
        exit(-1);
    }
    base64_avx2_encode(b64, data2, sizeof(data2));
    ...
    base64_avx2_encode(b64, data3, sizeof(data3));
    ...
    base64_avx2_encode(b64, data4, sizeof(data4));
    ...
    // test decode
    if (base64_avx2_decode(data, b64_1, strlen(b64_1)))
    {
        fprintf(stderr, "err in base64_avx2_decode, file: %s, line: %d\n",
                __FILE__, __LINE__);
        exit(-1);
    }
    if (base64_avx2_decode_outl(b64_1, strlen(b64_1)) != sizeof(data1) ||
    ...
    if (base64_avx2_decode(data, b64_2, strlen(b64_2)))
    {
        fprintf(stderr, "err in base64_avx2_decode, file: %s, line: %d\n",
                __FILE__, __LINE__);
        exit(-1);
    }
    if (base64_avx2_decode_outl(b64_2, strlen(b64_2)) != sizeof(data2) ||
    ...
    if (base64_avx2_decode(data, b64_3, strlen(b64_3)))
    {
        fprintf(stderr, "err in base64_avx2_decode, file: %s, line: %d\n",
                __FILE__, __LINE__);
        exit(-1);
    }
    if (base64_avx2_decode_outl(b64_3, strlen(b64_3)) != sizeof(data3) ||
    ...
    if (base64_avx2_decode(data, b64_4, strlen(b64_4)))
    {
        fprintf(stderr, "err in base64_avx2_decode, file: %s, line: %d\n",
                __FILE__, __LINE__);
        exit(-1);
    }
    if (base64_avx2_decode_outl(b64_4, strlen(b64_4)) != sizeof(data4) ||
