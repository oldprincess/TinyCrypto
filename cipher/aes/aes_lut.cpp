...
{
    static const uint32_t Rcon[10] = {0x01, 0x02, 0x04, 0x08, 0x10,
...
{
    const uint32_t *round_key = ctx->round_key;
    uint32_t        state[4];
    //----------------AddRoundKey----------------
                           ...
                           size_t              block_num)
{
    while (block_num)
    {
        aes128_lut_enc_block(ctx, ciphertext, plaintext);
        ciphertext += 16;
        plaintext += 16;
        block_num -= 1;
    }
                           ...
                           size_t              block_num)
{
    while (block_num)
    {
        aes128_lut_dec_block(ctx, plaintext, ciphertext);
        ciphertext += 16;
        plaintext += 16;
        block_num -= 1;
    }
                           ...
                           size_t              block_num)
{
    while (block_num)
    {
        aes192_lut_enc_block(ctx, ciphertext, plaintext);
        ciphertext += 16;
        plaintext += 16;
        block_num -= 1;
    }
                           ...
                           size_t              block_num)
{
    while (block_num)
    {
        aes192_lut_dec_block(ctx, plaintext, ciphertext);
        ciphertext += 16;
        plaintext += 16;
        block_num -= 1;
    }
                           ...
                           size_t              block_num)
{
    while (block_num)
    {
        aes256_lut_enc_block(ctx, ciphertext, plaintext);
        ciphertext += 16;
        plaintext += 16;
        block_num -= 1;
    }
                           ...
                           size_t              block_num)
{
    while (block_num)
    {
        aes256_lut_dec_block(ctx, plaintext, ciphertext);
        ciphertext += 16;
        plaintext += 16;
        block_num -= 1;
    }
