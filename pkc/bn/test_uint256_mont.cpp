...
static bool test_uint256_mont_div2()
{
    // clang-format off
    static int num = 4;
    static uint8_t a_0[32] ={0x11, 0x5e, 0xd6, 0x59, 0x5f, 0x70, 0xa4, 0xdb, 0xc2, 0x20, 0x72, 0x12, 0x57, 0x45, 0x51, 0x47, 0x9d, 0x4b, 0x68, 0x1a, 0x95, 0xaf, 0x89, 0x73, 0x02, 0xdf, 0xf8, 0xb1, 0xb0, 0xf8, 0x1e, 0x77, };
    static uint8_t c_0[32] ={0x88, 0xaf, 0x6b, 0x2c, 0x2f, 0xb8, 0x52, 0x6d, 0xe1, 0x10, 0x39, 0x09, 0x2b, 0xa2, 0xa8, 0xa3, 0xce, 0xa5, 0xb4, 0x0c, 0xca, 0xd7, 0xc4, 0xba, 0x01, 0x6f, 0xfc, 0x58, 0xd8, 0x7c, 0x0f, 0x3b, };
    static uint8_t a_1[32] ={0x8a, 0xc9, 0x9b, 0xdb, 0xf2, 0x1a, 0x49, 0xad, 0xe6, 0x7c, 0x44, 0x90, 0x6b, 0xbe, 0x39, 0x10, 0x62, 0x18, 0x27, 0x92, 0x86, 0xe3, 0x06, 0xe8, 0x1f, 0x25, 0x58, 0x55, 0x8d, 0x59, 0xac, 0x44, };
    static uint8_t c_1[32] ={0x45, 0x64, 0xcd, 0xed, 0xf9, 0x0d, 0x24, 0xd6, 0xf3, 0x3e, 0x22, 0x48, 0x35, 0xdf, 0x1c, 0x88, 0x31, 0x0c, 0x13, 0xc9, 0x43, 0x71, 0x83, 0x74, 0x0f, 0x92, 0xac, 0x2a, 0xc6, 0xac, 0xd6, 0x22, };
    static uint8_t a_2[32] ={0xf7, 0x6b, 0xf5, 0x33, 0x44, 0xca, 0xa4, 0xa7, 0xb1, 0x33, 0x10, 0x8f, 0x28, 0x69, 0x48, 0x41, 0xbb, 0x40, 0x20, 0x46, 0x12, 0x52, 0xe3, 0x18, 0xaa, 0x51, 0x85, 0x5b, 0x88, 0x11, 0xfe, 0xca, };
    static uint8_t c_2[32] ={0x7b, 0xb5, 0xfa, 0x99, 0xa2, 0x65, 0x52, 0x53, 0xd8, 0x99, 0x88, 0x47, 0x94, 0x34, 0xa4, 0x20, 0xdd, 0xa0, 0x10, 0x23, 0x09, 0x29, 0x71, 0x8c, 0x55, 0x28, 0xc2, 0xad, 0xc4, 0x08, 0xff, 0x65, };
    static uint8_t a_3[32] ={0x25, 0x9f, 0xb7, 0x47, 0xf3, 0xb5, 0xe5, 0x75, 0xca, 0xa4, 0xf5, 0x7d, 0x1f, 0xf9, 0x28, 0xa3, 0x5b, 0x9e, 0x45, 0xe4, 0x06, 0xdc, 0xc4, 0x9f, 0x0b, 0x25, 0x42, 0x60, 0xd9, 0x19, 0xb7, 0xd1, };
    static uint8_t c_3[32] ={0x92, 0xcf, 0xdb, 0xa3, 0x79, 0xda, 0xf2, 0xba, 0xe5, 0x52, 0x7a, 0xbe, 0x8f, 0xfc, 0x94, 0x51, 0xad, 0xcf, 0x22, 0xf1, 0x83, 0x6e, 0x62, 0x50, 0x05, 0x92, 0xa1, 0x30, 0x6c, 0x8c, 0xdb, 0xe8, };
    ...
    for (int i = 0; i < num; i++)
    {
        uint256_mont_from_bytes(&SM2_FP_MONT_CTX, x, a[i]);
        uint256_mont_from_bytes(&SM2_FP_MONT_CTX, z, c[i]);
        uint256_mont_div2(&SM2_FP_MONT_CTX, x, x);
        if (!uint256_mont_equal(&SM2_FP_MONT_CTX, x, z))
        {
            return false;
        }
    }
