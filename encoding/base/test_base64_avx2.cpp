...
static void test_base64_avx2()
{
    ...
    // test decode
    base64_avx2_decode(data, b64_1, strlen(b64_1));
    ...
    base64_avx2_decode(data, b64_2, strlen(b64_2));
    ...
    base64_avx2_decode(data, b64_3, strlen(b64_3));
    ...
    base64_avx2_decode(data, b64_4, strlen(b64_4));
