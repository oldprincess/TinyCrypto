...
static void test_base64_chromium()
{
    ...
    char    b64[60];
    // test encode
    base64_chromium_encode(b64, data1, sizeof(data1));
    if (strcmp(b64, b64_1) != 0)
    {
        fprintf(stderr, "err in base64_chromium_encode, file: %s, line: %d\n",
                __FILE__, __LINE__);
        exit(-1);
    }
    base64_chromium_encode(b64, data2, sizeof(data2));
    ...
    base64_chromium_encode(b64, data3, sizeof(data3));
    ...
    base64_chromium_encode(b64, data4, sizeof(data4));
...
int main()
{
    test_base64_chromium();
    puts("base64 chromium test ok");
    return 0;
}
